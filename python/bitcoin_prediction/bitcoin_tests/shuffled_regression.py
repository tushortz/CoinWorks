...
DAILY_OCCURRENCE_FILE_PATH = "data/daily" + METHOD + "Matrices/"
...
def get_normalized_matrix_from_file(day, year, totaltx):
    daily_occurrence_matrix_path_name = DAILY_OCCURRENCE_FILE_PATH + METHOD.lower() + str(year) + '{:03}'.format(day) + ".csv"
